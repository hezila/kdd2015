...
pypy py/extract_feature.py -t course -d train -l data/log_train.csv -e data/enrollment_train.csv -g data/truth_train.csv -o data/object.csv -f data/train_course_feature.csv
pypy py/extract_feature.py -t course -d test -l data/log_test.csv -e data/enrollment_train.csv -g data/truth_train.csv -o data/object.csv -f data/test_course_feature.csv
