    ...
    def _extract_simple_features(self, iter):
        for bag in iter:
            ...
            yield bag.extract_request_year()\
                .extract_request_mean_time()\
                .extract_request_exam_holiday()\
                ...
                .extract_video_count()\
                .extract_video_count_lstweek(2)\
                .extract_video_count_lstweek(1)\
                .extract_access_count()\
                .extract_access_count_lstweek(2)\
                .extract_access_count_lstweek(1)\
                .extract_browser_events()\
                .extract_browser_events_lst2week()\
                .extract_browser_events_lst1week()\
                .extract_source_count()\
                .extract_hour_count()\
                .extract_session_count(1)\
                .extract_session_count(2)\
                .extract_session_count(3)\
                .extract_session_lstweek(1, 2)\
                .extract_session_lstweek(1, 1)\
                .extract_session_lstweek(2, 2)\
                .extract_session_lstweek(2, 1)\
                .extract_session_lstweek(3, 2)\
                .extract_session_lstweek(3, 1)\
                .extract_session_per_day(1)\
                .extract_session_per_day(2)\
                .extract_session_per_day(3)\
                .extract_request_lag()\
                .extract_request_lags()\
                .extract_staytime()\
                .extract_staytime_lstweek(2)\
                .extract_staytime_lstweek(1)\
